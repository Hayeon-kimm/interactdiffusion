...
class HICODataset(HOIBaseDataset):
    def __init__(self,
        ...
        # Load tsv data
        with open('/data2/rlagkdus705/trainval_hico_sg3.json') as file :
            annotations = json.load(file)
        self.annotations = annotations
        
        self.train_files = glob.glob(os.path.join(self.dataset_path, 'embed_*.clip.pt'))
        self.test_files = glob.glob(os.path.join('../DATA/hico_det_clip_test', 'embed_*.clip.pt'))
