...
class Trainer:
    def __init__(self, config, device="cuda"):
        ...
        # print("check : ", config.train_dataset_names, config.DATA_ROOT, train_dataset_repeats, config)
    ...
    def run_one_step(self, batch):
        ...
        grounding_input = self.grounding_tokenizer_input.prepare(batch) # HERE
